...
namespace N5.Challenge.Infrasctructure.Migrations
{
    ...
    [Migration("20231116222731_EnabledField")]
    partial class EnabledField
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("N5.Challenge.Domain.Employee", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedOn")
                        ...
                        .HasDefaultValue(new DateTime(2023, 11, 16, 22, 27, 31, 671, DateTimeKind.Utc).AddTicks(508));
            ...
            modelBuilder.Entity("N5.Challenge.Domain.Permission", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedOn")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 11, 16, 22, 27, 31, 671, DateTimeKind.Utc).AddTicks(7557));
            ...
            modelBuilder.Entity("N5.Challenge.Domain.PermissionType", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedOn")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 11, 16, 22, 27, 31, 671, DateTimeKind.Utc).AddTicks(9623));
